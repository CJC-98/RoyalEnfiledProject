...
<html lang="en">
	<head>
		...
		<link href="${pageContext.request.contextPath}/Resources/WebSite/fonts/font-awesome.min.css" rel="stylesheet" type="text/css">
		<link href="${pageContext.request.contextPath}/Resources/WebSite/fonts/lineo-icon/style.css" rel="stylesheet" type="text/css">

		<!-- Loading main css file -->
		<link rel="stylesheet" href="${pageContext.request.contextPath}/Resources/WebSite/style.css">
	...
	<body>
		...
		<div id="site-content">
			<header class="site-header">
				<div class="top-header" style="padding-bottom: 5px;padding-top: 5px;height: 70px;">
					<div class="container">
						<a href="/" id="branding">
							<img src="${pageContext.request.contextPath}/Resources/WebSite/images/logo.png" alt="Company Name" class="logo">
							<div class="logo-text">
								<h1 class="site-title">WEALTH CARE</h1>
								<small class="description">Insurance</small>
							</div>
						</a> <!-- #branding -->
					
						<div class="right-section pull-right">
							<a href="#" class="phone"><img src="${pageContext.request.contextPath}/Resources/WebSite/images/icon-phone.png" class="icon">+1 823 424 9134</a>
					
							<form action="#" class="search-form">
								<input type="text" placeholder="Search...">
								<button type="submit"><img src="${pageContext.request.contextPath}/Resources/WebSite/images/icon-search.png" alt=""></button>
							</form>
						</div>
					</div> <!-- .container -->
				</div> <!-- .top-header -->
					...
					<div class="container">
						<div class="main-navigation">
							...
							<ul class="menu">
								...
								<li class="menu-item"><a href="loginPage">Login</a></li>
								
								<li class="menu-item"><a href="registerPage">Here you Register</a></li>
							</ul> <!-- .menu -->
						</div> <!-- .main-navigation -->
			...
			<div class="hero hero-slider">
				<ul class="slides">
					<li data-bg-image="${pageContext.request.contextPath}/Resources/WebSite/dummy/slide-1.jpg">
						<div class="container">
					...
					<li data-bg-image="${pageContext.request.contextPath}/Resources/WebSite/dummy/slide-3.jpg">
						<div class="container">
							<div class="slide-content">
								<h2 class="slide-title">Get your <strong>Life Insurance</strong></h2>
								<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Repellendus quos cumque odio soluta harum error sequi laudantium, est nam perspiciatis eveniet maxime, esse possimus architecto sunt natus reprehenderit debitis fugit.</p>
			...
			<main class="main-content">
						...
						<div class="row">
							<div class="col-md-3">
								<div class="offer caption-top">
									<img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/offer-tall.jpg" alt="offer 1">
									<div class="caption">
							...
							<div class="col-md-9">
								<div class="row">
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/offer-1.jpg" alt="offer 2">
											<div class="caption">
									...
									<div class="col-md-8">
										<div class="offer caption-bottom">
									<img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/offer-wide.jpg" alt="offer 3">
									<div class="caption">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/offer-2.jpg" alt="offer 2">
											<div class="caption">
												<h3 class="offer-title">Curabitur vehicula</h3>
												<small>Conubia nostra per inceptos</small>	
											</div>
									...
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/offer-3.jpg" alt="offer 2">
											<div class="caption">
												<h3 class="offer-title">Curabitur vehicula</h3>
												<small>Conubia nostra per inceptos</small>	
											</div>
									...
									<div class="col-md-4">
										<div class="offer caption-bottom">
											<img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/offer-4.jpg" alt="offer 2">
											<div class="caption">
												<h3 class="offer-title">Curabitur vehicula</h3>
												<small>Conubia nostra per inceptos</small>	
											</div>
				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="row news-list">
							<div class="col-md-4">
								<div class="news">
									<figure><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/featured-image-1.jpg" alt=""></figure>
									<div class="date"><img src="${pageContext.request.contextPath}/Resources/WebSite/images/icon-calendar.png" alt="">03/09/2014</div>
									<h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									<figure><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/featured-image-2.jpg" alt=""></figure>
									<div class="date"><img src="${pageContext.request.contextPath}/Resources/WebSite/images/icon-calendar.png" alt="">03/09/2014</div>
									<h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
								</div>
							</div>
							<div class="col-md-4">
								<div class="news">
									<figure><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/featured-image-3.jpg" alt=""></figure>
									<div class="date"><img src="${pageContext.request.contextPath}/Resources/WebSite/images/icon-calendar.png" alt="">03/09/2014</div>
									<h2 class="entry-title"><a href="#">Donec laoreet non nec aliquam pellentesque interdum</a></h2>
								</div>
							</div>
				...
				<div class="fullwidth-block">
					<div class="container">
						...
						<div class="partners">
							<a href="#"><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/money-logo.png" alt=""></a>
							<a href="#"><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/nyt-logo.png" alt=""></a>
							<a href="#"><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/forbes-logo.png" alt=""></a>
							<a href="#"><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/wsj-logo.png" alt=""></a>
							<a href="#"><img src="${pageContext.request.contextPath}/Resources/WebSite/dummy/bbs-logo.png" alt=""></a>
						</div> <!-- .partners -->
					</div> <!-- .container -->
				</div> <!-- .fullwidth-block -->
		...
		<script src="${pageContext.request.contextPath}/Resources/WebSite/js/jquery-1.11.1.min.js"></script>
		<script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
		<script src="${pageContext.request.contextPath}/Resources/WebSite/js/plugins.js"></script>
		<script src="${pageContext.request.contextPath}/Resources/WebSite/js/app.js"></script>

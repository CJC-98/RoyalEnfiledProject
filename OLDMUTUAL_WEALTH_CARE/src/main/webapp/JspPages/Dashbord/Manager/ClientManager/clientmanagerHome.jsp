...
<img src="${pageContext.request.contextPath}/Resources/WebSite/images/logo.png" alt="Company Name" class="logo">
                ...
                <a class="navbar-brand hidden" href="adminHome.jsp"><img src="${pageContext.request.contextPath}/Resources/DashbordResources/images/logo2.png" alt="Logo"></a>
            </div>
    ...
    <div id="right-panel" class="right-panel">
      ...
      <%@ include file="clientmanagerHeader.jsp" %>

...
<div class="container">
    ...
    <tbody>
      ...
      <tr>
      		<td><%out.print(us.getUserID());%></td>
      
        <td><%out.print(us.getUserName());%></td>
		<td><%out.print(us.getUserEmail());%></td>
		<td><%out.print(us.getUserDOB());%></td>
		<td><%out.print(us.getUsercontact());%></td>
		<td><%out.print(us.getUserAddress());%></td>
		<td><%out.print(us.getUserArea());%></td>
		<td><%out.print(us.getUserPin());%></td>
		<td><%out.print(us.getUserName());%></td>
<%-- 		<td><%out.print(us.getAdvisor().getAdvisorID());%></td>
 --%>
		<td>____</td> 
       </tr>      

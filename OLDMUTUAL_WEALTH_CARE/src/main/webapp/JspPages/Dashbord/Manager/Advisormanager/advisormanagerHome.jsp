...
<!-- -- -->
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/Resources/DashbordResources/scss/style.css">
        <link rel="stylesheet" href="${pageContext.request.contextPath}/Resources/DashbordResources/font-awesome">
...
<!--  		       <li><i class="fas fa-user-ninja"></i><a data-toggle="modal" data-target="#myModal">Add advisor</a></li>
...
<!-- <!-- ------------------------- style=" max-width: 1000px;height: 5000px;background-color: powderblue;"-->
<!--  
...
function register() {
	...
	alert(adpin)
	alert(document.getElementById("adarea").value);
	alert(document.getElementById("admag").value);
	alert(document.getElementById("adexp").value);
	
	alert(document.getElementById("adun").value);
	alert(document.getElementById("adpass").value);
	document.rform.action="register";
...
<div  class="modal fade" id="myModal" role="dialog" style=" max-width: 600px;height: 500px; background-color: #d2d2d2;">
    ...
    <hr>
	<label for="advisorID"><b>Advisor ID</b></label>
    <input type="text"id="adid" placeholder="Enter ID" name="advisorID" required>

	<label for="advisorName"><b>Advisor Name</b></label>
    <input type="text"id="adname" placeholder="Enter advisorName" name="advisorName" required>

	<label for="advisorEmail"><b>Advisor Email</b></label>
    <input type="text" id="ademail" placeholder="Enter advisorEmail" name="advisorEmail" required>

	<label for="advisorDOB"><b>Advisor DOB</b></label>
    <input type="date"  id="DOB"placeholder="Enter DOB" name="advisorDOB" required>

	<label for="advisorContactno"><b>Advisor mobile</b></label>
    <input type="text" id="admob" placeholder="Enter number" name="advisorContactno" required>

	<label for="advisorAddress"><b>Advisor Address</b></label>
    <input type="text" id="adadd" placeholder="Enter Address" name="advisorAddress" required>

	<label for="advisorAddPin"><b>Address Pin code</b></label>
    <input type="text" id="adpin" placeholder="Enter advisorAddPin" name="advisorAddPin" required>

 	<label for="advisorArea"><b>Advisor Area</b></label>
    <input type="text" id="adarea" placeholder="Enter Area" id="area"name="advisorArea" required>
   
    <label for="advisormanager"><b>Assign manager</b></label>
    <input type="text" id="admag" placeholder="Null" name="advisormanager" required>

 
	<label for="addvisorExperince"><b>Addvisor Experince (in years)</b></label>
    <input type="text" id="adexp" placeholder="Enter addvisor Experince" name="addvisorExperince" required>
    

	<label for="advisorUserName"><b>Advisor User Name</b></label>
    <input type="text" id="adun" placeholder="Enter Advisor User Name" name="advisorUserName" required>

    <label for="advisorPassword"><b>advisorPassword</b></label>
    <input type="text" id="adpass" placeholder="Enter Password" name="advisorPassword" required>

    </hr>
    <p>By creating an account you agree to our <a href="#">Terms & Privacy</a>.</p>

    <button type="submit" class="registerbtn" value="register" onclick="register()">Register</button>
 	<input type="submit" class="registerbtn" value="register" onclick="register()">
  </div>
  </pre>

...
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/Resources/styles/bootstrap-4.1.3/bootstrap.css">
		...
		<div class="header_content d-flex flex-row align-items-center justify-content-start">
			...
			<!-- <nav class="header_nav">
				<ul class="d-flex flex-row align-items-center justify-content-start">
					...
					<li><a href="register">register you here</a></li>
					<li><a href="index.html">h23ome</a></li>
			...
			<div class="header_extra ml-auto d-flex flex-row align-items-center justify-content-start">
				...
				<%-- <div class="info_languages has_children">
					...
					<!-- Language Dropdown Menu -->
					 <ul>
					 	<li><a href="#">
				 			<div class="language_flag"><img src="${pageContext.request.contextPath}/Resources/images/flag_2.svg" alt="https://www.flaticon.com/authors/freepik"></div>
							<div class="dropdown_text">french</div>
					 	</a></li>
					 	<li><a href="#">
				 			<div class="language_flag"><img src="${pageContext.request.contextPath}/Resources/images/flag_3.svg" alt="https://www.flaticon.com/authors/freepik"></div>
							<div class="dropdown_text">japanese</div>
					 	</a></li>
					 	<li><a href="#">
				 			<div class="language_flag"><img src="${pageContext.request.contextPath}/Resources/images/flag_4.svg" alt="https://www.flaticon.com/authors/freepik"></div>
							<div class="dropdown_text">russian</div>
					 	</a></li>
					 	<li><a href="#">
				 			<div class="language_flag"><img src="${pageContext.request.contextPath}/Resources/images/flag_5.svg" alt="https://www.flaticon.com/authors/freepik"></div>
	...
	<div class="sidebar">
		...
		<div class="info">
			<div class="info_content d-flex flex-row align-items-center justify-content-start">
				...
				<!-- Language -->
				<%-- <div class="info_languages has_children">
					<div class="language_flag"><img src="${pageContext.request.contextPath}/Resources/images/flag_1.svg" alt="https://www.flaticon.com/authors/freepik"></div>
					<div class="dropdown_text">english</div>
					<div class="dropdown_arrow"><i class="fa fa-angle-down" aria-hidden="true"></i></div>
		...
		<nav class="sidebar_nav">
			<ul>
				...
				<li><a href="registerPage">register you here<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
				<li><a href="loginPage">login<i class="fa fa-angle-right" aria-hidden="true"></i></a></li>
	...
	<%-- <div class="home">
		...
		<div class="home_slider_container">
			<div class="owl-carousel owl-theme home_slider">
				...
				<!-- Slide -->
				<div class="owl-item">
					<div class="background_image" style="background-image:url(${pageContext.request.contextPath}/Resources/images/home_slider_1.jpg)"></div>
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="${pageContext.request.contextPath}/Resources/images/box_1.jpg" alt=""></div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="${pageContext.request.contextPath}/Resources/images/box_2.jpg" alt=""></div>
					...
					<div class="col-lg-4 box_col">
						<div class="box">
							<div class="box_image"><img src="${pageContext.request.contextPath}/Resources/images/box_3.jpg" alt=""></div>
						...
						<div class="col-xxl-3 col-md-6 footer_col">
							<div class="footer_about">
								...
								<div class="footer_logo">
									<a href="#"><div>OLD MUTUAL<br><span>Wealth Care</span></div></a>
								</div>
								...
								<div class="cards">
									<ul class="d-flex flex-row align-items-center justify-content-start">
										<li><a href="#"><img src="${pageContext.request.contextPath}/Resources/images/card_1.jpg" alt=""></a></li>
										<li><a href="#"><img src="${pageContext.request.contextPath}/Resources/images/card_2.jpg" alt=""></a></li>
										<li><a href="#"><img src="${pageContext.request.contextPath}/Resources/images/card_3.jpg" alt=""></a></li>
										<li><a href="#"><img src="${pageContext.request.contextPath}/Resources/images/card_4.jpg" alt=""></a></li>
										<li><a href="#"><img src="${pageContext.request.contextPath}/Resources/images/card_5.jpg" alt=""></a></li>
									</ul>
								</div>
							</div>
						</div>
							...
							<div class="footer_blog">
								...
								<div class="footer_blog_container">
									...
									<div class="footer_blog_item d-flex flex-row align-items-start justify-content-start">
										<div class="footer_blog_image"><a href="blog.html"><img src="${pageContext.request.contextPath}/Resources/images/footer_blog_1.jpg" alt=""></a></div>
									...
									<!-- Blog Item -->
									<div class="footer_blog_item d-flex flex-row align-items-start justify-content-start">
										<div class="footer_blog_image"><a href="blog.html"><img src="${pageContext.request.contextPath}/Resources/images/footer_blog_2.jpg" alt=""></a></div>
										<div class="footer_blog_content">
						...
						<div class="col-xxl-3 col-md-6 footer_col">
							<div class="footer_contact">
								...
								<div class="footer_contact_list">
									<ul>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>C.</span><div>ExtremityIndia Technologies Ltd</div></li>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>A.</span><div>1st Floor,Above Roopam Sweets, Karvenagar, Pune</div></li>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>T.</span><div>+8888022204</div></li>
										<li class="d-flex flex-row align-items-start justify-content-start"><span>E.</span><div>hr@extremityidia.com</div></li>
									</ul>
								</div>
							</div>
						</div>
...
<script src="${pageContext.request.contextPath}/Resources/styles/bootstrap-4.1.3/popper.js"></script>
<script src="${pageContext.request.contextPath}/Resources/styles/bootstrap-4.1.3/bootstrap.min.js"></script>
...
<script src="${pageContext.request.contextPath}/Resources/plugins/Isotope/fitcolumns.js"></script>

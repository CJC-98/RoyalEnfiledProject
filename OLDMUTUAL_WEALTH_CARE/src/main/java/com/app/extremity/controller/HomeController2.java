...
public class HomeController2 {
	...
	public String assignAdv(@RequestParam(name="advisorAddPin") String adpin){
	
		System.out.println("assign controller"+adpin);
		
		//System.out.println(advisorAddPin);
		
		//service.getAdvisors(advisorAddPin);
		return null;
	}*/

	/*@RequestMapping("/assign")	
	public ResponseEntity<Advisors> assignAdv(@RequestParam(name="advisorAddPin") String adpin){
